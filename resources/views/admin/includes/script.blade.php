...
<!-- jQuery UI 1.11.4 -->
<script src="{{asset('public/adminpanel/assets/vendor_components/jquery-ui/jquery-ui.js')}}"></script>
...
<!-- peity -->
<script src="{{asset('public/adminpanel/assets/vendor_components/jquery.peity/jquery.peity.js')}}"></script>

<!-- NeoX Admin App -->
<script src="{{asset('public/adminpanel/js/template.js')}}"></script>

<!-- NeoX Admin dashboard demo (This is only for demo purposes) -->
<script src="{{asset('public/adminpanel/js/pages/dashboard.js')}}"></script>
